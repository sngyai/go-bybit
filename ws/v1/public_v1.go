...
// SubscribeTrade :
func (s *SpotWebsocketV1PublicV1Service) SubscribeTrade(symbol bybit.SymbolSpot, f func(response SpotWebsocketV1PublicV1TradeResponse) error) (func() error, error) {
